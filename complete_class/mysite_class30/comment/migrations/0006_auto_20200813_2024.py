# Generated by Django 2.0 on 2020-08-13 12:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('comment', '0005_auto_20200809_2033'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='parent',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='parent_commment', to='comment.Comment'),
        ),
        migrations.AlterField(
            model_name='comment',
            name='reply_to',
